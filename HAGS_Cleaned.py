...
def HDRI_EAF_Model(eta_el,h2_prod_yr,plant_life,tax_rate,interest_rate,electricity_cost,iron_ore_cost,emission_cost,carbon_steel_price,O2_price,el_spec,h2_investment_2020,emission_factor,elec_limit):
    ...
    H2_weight_per_mol=(H2_per_mol*mol_weight_H2)   #Kg h2 per 1 mol fe
    mol_per_ton_fe=(1000000)/mol_weight_fe                 #mols of iron in a 1000 kg of fe
    ...
    h2_prod_hr=h2_prod_yr/operating_hours  #h2 (kg) produced per hour
    ...
    steel_per_hr=h2_prod_hr/h2_per_ton_actual   #Steel prduced per hour based off h2 restriction (tls/hr)
    ...
    water_tls=((3*mol_weight_H2O)/(2*mol_weight_fe))*1000  #water produced kg per tonne liquid steel
    ...
    def electrolyzer_npv(eta_el,tax_rate,interest_rate,electricity_cost,iron_ore_cost,emission_cost,carbon_steel_price,O2_price,el_spec,h2_investment_2020,emission_factor):
        ...
        el_elec=(m4*el_spec)  #Electrolyzer Electricity kWh/tls
        ...
        h2_per_hour_kg=steel_per_hr*m4 #kg h2/hr
        h2_per_second_kg=(h2_per_hour_kg)/3600
        lhv_h2=120.1 #Mj/kgh2 low heating value
        h2_capacity_MW=h2_per_second_kg*lhv_h2  #Mj/s or MW h2 energy
        #electrolyzer_efficiency=0.67
        #el_capacity_mwel=h2_capacity_MW/electrolyzer_efficiency
        h2_per_year=h2_per_hour_kg*operating_hours #check could be deleted
        ...
        h2_investment_MW_h2=(h2_investment_2020*Euro_dollar_conversion) #.708 Million USD per MW Electrolyzer Cost
