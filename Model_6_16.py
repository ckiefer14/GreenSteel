...
def electrolyzer_npv(tax_rate,interest_rate,electricity_cost,iron_ore_cost,emission_cost,carbon_steel_price,O2_price,el_spec,h2_investment_2020):
    ...
    # Plant is operating 95% of the time
    ...
    print('Electricity required in the Electric Arc Furnace in (kwh): ',np.around(el_eaf,3))
    print('Electricity required in the Electrolyzer in (kwh): ',np.around(el_elec,3))
    print('Electricity required in the Heater in (kwh): ',np.around(el_heater,3))
    ...
    print('Total Income of plant in Million USD: ',income)
